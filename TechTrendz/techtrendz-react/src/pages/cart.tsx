                        ...
                        <div className="grow w-full">
                            {cartDto.map((item: CartDTO) =>
                                <div className="w-full shadow-inherit shadow-sm rounded-sm p-1" key={item.id}>
                                    ...
                                    <div className="text-xs font-thin w-full flex justify-between link" onClick={() => { setEditCartItem(item); setShowCartItemModal(true); }}>
                                        <div className="hover:scale-x-105 w-fit cursor-pointer text-inherit">{item.count} {item.count! > 1 ? "items" : "item"} in cart</div>
                                    </div>
                                </div>
                            )}
                        </div>
